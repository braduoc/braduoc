...
- **[Sistema de Punto de Venta](https://github.com/braduoc/sistema-punto-venta-react-dotnet)** — React + ASP.NET Core + Entity Framework Core + SQL Server. Gestión de usuarios, productos y ventas con dashboard de métricas y reportes.
